...
type SessionLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.Session, err error)
...
type sessionLister struct {
	listers.ResourceIndexer[*apiv1alpha1.Session]
}

// NewSessionLister returns a new SessionLister.
func NewSessionLister(indexer cache.Indexer) SessionLister {
	return &sessionLister{listers.New[*apiv1alpha1.Session](indexer, apiv1alpha1.Resource("session"))}
}

// Sessions returns an object that can list and get Sessions.
func (s *sessionLister) Sessions(namespace string) SessionNamespaceLister {
	return sessionNamespaceLister{listers.NewNamespaced[*apiv1alpha1.Session](s.ResourceIndexer, namespace)}
}
...
type SessionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.Session, error)
