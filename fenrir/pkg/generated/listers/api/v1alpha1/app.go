...
type AppLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.App, err error)
...
type appLister struct {
	listers.ResourceIndexer[*apiv1alpha1.App]
}

// NewAppLister returns a new AppLister.
func NewAppLister(indexer cache.Indexer) AppLister {
	return &appLister{listers.New[*apiv1alpha1.App](indexer, apiv1alpha1.Resource("app"))}
}

// Apps returns an object that can list and get Apps.
func (s *appLister) Apps(namespace string) AppNamespaceLister {
	return appNamespaceLister{listers.NewNamespaced[*apiv1alpha1.App](s.ResourceIndexer, namespace)}
}
...
type AppNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.App, error)
